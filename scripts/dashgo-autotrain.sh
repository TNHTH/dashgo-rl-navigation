...
def supervisor_pid():
    pid_file = pathlib.Path("/home/gwh/dashgo_rl_project/autopilot/metrics/continuous_gen2_supervisor.pid")
...
if cmd == "status":
    ...
    print("  events: /home/gwh/dashgo_rl_project/autopilot/metrics/continuous_supervisor_events.jsonl")
    print("  supervisor_log: /home/gwh/dashgo_rl_project/autopilot/metrics/continuous_gen2_supervisor.nohup.log")
    current_run = state.get("active_run_name")
    if isinstance(current_run, str) and current_run:
        print(f"  current_run_log: /home/gwh/dashgo_rl_project/autopilot/metrics/{current_run}.log")
elif cmd == "report":
    print("# DashGo 自动训练报告")
    ...
    current_run = state.get("active_run_name")
    if isinstance(current_run, str) and current_run:
        print(f"- 当前 run 日志: /home/gwh/dashgo_rl_project/autopilot/metrics/{current_run}.log")
    print("- Supervisor 日志: /home/gwh/dashgo_rl_project/autopilot/metrics/continuous_gen2_supervisor.nohup.log")
    print("- 事件流: /home/gwh/dashgo_rl_project/autopilot/metrics/continuous_supervisor_events.jsonl")
else:
...
if not isinstance(run_name, str) or not run_name:
    raise SystemExit(1)
print(f"/home/gwh/dashgo_rl_project/autopilot/metrics/{run_name}.log")
PY
}
