...
# 方法2：导出指定模型
python apps/isaac/export_torchscript.py --checkpoint .artifacts/train/logs/model_900.pt
```
...
# 应该输出: /home/gwh/dashgo_rl_project/workspaces/ros1_catkin_ws/devel/lib/dashgo_rl/geo_nav_node.py

# 检查包路径
rospack find dashgo_rl
# 应该输出: /home/gwh/dashgo_rl_project/workspaces/ros1_catkin_ws/src/dashgo_rl
```
