...
# 查找所有未解决的问题
grep -r "状态: 未解决" issues/

# 查找今天的问题
ls -lt issues/2024-01-24*.md
```

### 按关键词查找
```bash
# 查找"参数"相关的问题
find issues/ -name "*参数*.md"

# 查找"训练"相关的问题
find issues/ -name "*训练*.md"
```
...
### 当项目彻底跑通后
1. 整理所有已解决问题
2. 编写"彻底跑通指南"（保存到 `docs/`）
3. 存档问题记录到 `issues/solved/`
4. 作为新项目的指导文档
