...
The Kaizen skill guides how you work. Apply these principles continuously:

- **Continuous Improvement**: Suggest small incremental changes
- **Poka-Yoke**: Use type systems and validation to prevent errors
- **Standardized Work**: Follow existing patterns in the codebase
- **Just-In-Time**: Build only what's needed now
